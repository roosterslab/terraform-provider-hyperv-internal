param(
  ...
  [string]$VmName = "user-tfv2-with-switch",
...
try {
  ...
  terraform apply -auto-approve -input=false -var "endpoint=$Endpoint" -var "vm_name=$VmName" -var "switch_name=$SwitchName" | Write-Host
} finally { popd }
